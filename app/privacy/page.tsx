...
const PrivacyPolicy = () => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to MotoInfo.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to MotoInfo, accessible from{" "}
            <a
              href="https://www.motoinfo.online/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.motoinfo.online/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: omojjegomosc@gmail.com</li>
      </ul>
    </div>
  );
};
